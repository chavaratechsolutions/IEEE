...
export default function CommitteesSection() {
    ...
    const allMembers: CommitteeMember[] = [
        { name: "Dr. Josephkutty Jacob", designation: "General Chair", affiliation: "Principal, CCET" },
        ...
        { name: "Dr. Syamala S", designation: "TPC Chair", affiliation: "Assistant Professor, IIIT Kottayam" },
        { name: "Dr Ragesh G K", designation: "TPC Chair", affiliation: "Assistant Professor, IIIT Kottayam" },
    ...
    const advisoryCommitteeMembers: CommitteeMember[] = [
        ...
        { name: "Dr BS Manoj", designation: "Professor and Dean, Chair, IEEE Kerala Section", affiliation: "IIST Trivandrum" },
        { name: "Dr Bijuna Kunju K", designation: "Professor", affiliation: "TKM College of Engineering, Kollam" },
        ...
        { name: "Dr. Sheik Mohammed Sulthan", designation: "Deputy Director of Centre for Transport Research", affiliation: "Faculty of engineering, Universiti Teknologi Brunei" },
    ...
    const technicalCommitteeMembers: CommitteeMember[] = [
        { name: 'Dr Raja Mohamed', designation: 'Professor', affiliation: 'University of Baharin' },
        { name: 'Dr Stella Morris', designation: 'Associate Professor', affiliation: 'Lee Kong Chian Faculty of Engineering and Science, Department of Electrical and Electronic Engineering, Universiti TunkuAbdul Rahman, Malaysia' },
        { name: 'Dr Rakesh Ramachandran', designation: 'Lead Electronics Specialist', affiliation: 'Electronics Technology, Grundfos, Bjerringbro, Denmark' },
        { name: 'Dr Sreenath J G', designation: 'Assistant Professor', affiliation: 'IIT Guwhati' },
        { name: 'Dr Jisha Mariyam John', designation: 'Assistant Professor', affiliation: 'IIIT Kottayam' },
